        ...
        <Fragment>
            <div className='container'>
                ...
                <div className='pb-[80px] pt-[20px]'>
                    <p>I am committed to crafting the best solutions for clients in a holistic fashion by understanding the broad scope of a client&apos;s business to develop strategic solutions that fit within the larger framework of their technical ecosystem.</p>
                </div>
            </div>
